		...
		after = function()
			...
			local function set_highlights()
				local highlights = {
					...
					RenderMarkdownIndent = { bg = palette.base02 },
					RenderMarkdownH1Bg = { bg = palette.base06 },
					RenderMarkdownH2Bg = { bg = palette.base05 },
					RenderMarkdownH3Bg = { bg = palette.base04 },
					RenderMarkdownH4Bg = { bg = palette.base03 },
					RenderMarkdownH5Bg = { bg = palette.base02 },
					RenderMarkdownH6Bg = { bg = palette.base01 },
					RenderMarkdownH1 = { fg = palette.base01 },
					RenderMarkdownH2 = { fg = palette.base02 },
					RenderMarkdownH3 = { fg = palette.base03 },
					RenderMarkdownH4 = { fg = palette.base04 },
					RenderMarkdownH5 = { fg = palette.base05 },
					RenderMarkdownH6 = { fg = palette.base06 },
