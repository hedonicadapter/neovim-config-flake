{
  ...
  in {
    ...
    in
      pkgs.wrapNeovim inputs.neovim-nightly-overlay.packages.${pkgs.system}.default {
        configure =
          neovimConfig
          // {
            files = {
              "lua/reactive/presets/customCursorLine.lua".text = import ./modules/nvim/plugins/reactive/customCursorLine.lua.nix {inherit (self) outputs;};
              "lua/options.lua".text = import ./modules/nvim/lua/options.lua.nix {inherit (self) outputs;};
            };
          };
      };
  };
